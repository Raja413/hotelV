...
{test: q => /\b(room|bed|suite|superior|accom|rooom|bathroom|washroom|toilet|balcony|wardrobe|cupboard|closet)\b/.test(q) || (/\b(king|twin)\b/.test(q) && !q.includes("burger")), response: "rooms"},
